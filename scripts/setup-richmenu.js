...
const AREAS = [
  { x: 0,    y: BTN_Y,             w: 834,  h: BTN_H / 2, key: 'インボイス・帳簿', emoji: '📄', label: 'インボイス・帳簿', sub: '適格請求書・電帳法',   bg: '#1B3A5C', accent: '#2E6DA4' },
  { x: 834,  y: BTN_Y,             w: 833,  h: BTN_H / 2, key: '経費・仕訳',       emoji: '💰', label: '経費・仕訳',       sub: '経費判断・勘定科目',   bg: '#145A32', accent: '#1E8449' },
  { x: 1667, y: BTN_Y,             w: 833,  h: BTN_H / 2, key: '確定申告・税務',   emoji: '📊', label: '確定申告・税務',   sub: '申告・消費税・調査',   bg: '#4A235A', accent: '#7D3C98' },
  { x: 0,    y: BTN_Y + BTN_H / 2, w: 1250, h: BTN_H / 2, key: '法人・給与',       emoji: '🏢', label: '法人・給与',       sub: '役員報酬・社会保険',   bg: '#6E2F0A', accent: '#CA6F1E' },
  { x: 1250, y: BTN_Y + BTN_H / 2, w: 1250, h: BTN_H / 2, key: 'その他',           emoji: '💬', label: 'その他・顧問相談', sub: '記帳代行・なんでも',   bg: '#1A2E40', accent: '#2E86C1' },
];

function drawHeader(ctx) {
  const grad = ctx.createLinearGradient(0, 0, W, HEADER_H);
  grad.addColorStop(0,   '#1a3a5c');
  grad.addColorStop(0.5, '#1e5a8a');
  ...
  const circles = [
    ...
    { x: 600,  y: 500,  r: 150, color: 'rgba(100,200,255,0.08)' },
    { x: 1900, y: 450,  r: 200, color: 'rgba(100,200,255,0.06)' },
  ];
  ...
  ctx.textAlign = 'center';
  ctx.textBaseline = 'middle';
  ctx.fillText('税理士 AI アシスタント', W / 2, 185);

  // サブタイトル
  ctx.fillStyle = 'rgba(255,255,255,0.75)';
  ctx.font = '48px sans-serif';
  ctx.fillText('税務・会計のご相談はこちら', W / 2, 290);
